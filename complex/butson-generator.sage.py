...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_13 = Integer(13); _sage_const_14 = Integer(14)#type: ignore
...
def process_circulant_core(chunk, n, d):
	...
	results = []
	for row in chunk:
		tail = row[_sage_const_2 :]
		for perm in list(Permutations(tuple(tail))):
			new_row = row[_sage_const_0 :_sage_const_2 ] + list(perm)
...
if __name__ == "__main__":
	...
	d_values = list(range(_sage_const_6 , _sage_const_7 ))
	n_values = list(range(_sage_const_13 , _sage_const_14 ))
	for d in d_values:
		R = CyclotomicField(d)
		zeta = R.gen()
