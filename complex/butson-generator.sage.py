...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_10 = Integer(10); _sage_const_11 = Integer(11); _sage_const_12 = Integer(12)#type: ignore
...
if __name__ == "__main__":
	...
	d_values = list(range(_sage_const_10 , _sage_const_11 ))
	n_values = list(range(_sage_const_2 , _sage_const_12 ))
	for d in d_values:
		R = CyclotomicField(d)
		zeta = R.gen()
