...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5)#type: ignore
...
if __name__ == "__main__":
	...
	d_values = [_sage_const_6 ]
	n_values = [_sage_const_5 , _sage_const_6 ]
	for d in d_values:
		R = CyclotomicField(d)
		zeta = R.gen()
